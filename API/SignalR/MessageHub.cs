                        ...
                        IMapper mapper) : Hub
{
    ...
    public async Task SendMessage(CreateMessageDto createMessageDto)
    {
        ...
        if (group != null && group.Connections.Any(a => a.Username == recipient.UserName))
        {
    ...
    {
        var group = await messageRepository.GetMessageGroup(Context.ConnectionId);
        var connection = group?.Connections.FirstOrDefault(a => a.ConnectionId == Context.ConnectionId);
